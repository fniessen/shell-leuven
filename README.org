...
if [ -d "$HOME/.dotfiles" ]; then
  # Set CDPATH to include the current directory, home directory, and ~/.dotfiles.
  export CDPATH=".:$HOME:$HOME/.dotfiles"
else
  # Set CDPATH to include the current directory and home directory only.
  export CDPATH=".:$HOME"
fi
#+end_src
...
#+begin_note
~e .~ opens the current directory in Emacs.
#+end_note
...
GREP_COLORS='sl=:cx=:mt=01;33;1;44:ms=01;33;1;44:mc=01;33;1;44:fn=35:ln=32:bn=32:se=36'
