...
#+begin_src shell :tangle no
git clone https://github.com/karlin/mintty-colors-solarized.git $HOME/.dotfiles/plugins/mintty-colors-solarized
#+end_src
...
if [ -r "$ZSH" ]; then
    ...
    # . $ZSH/plugins/svn/svn.plugin.zsh
fi
#+end_src
...
git clone https://github.com/zsh-users/zsh-syntax-highlighting.git \
    ${ZSH_CUSTOM:-~/.dotfiles/plugins/oh-my-zsh/custom}/plugins/zsh-syntax-highlighting
#+end_src
...
if [ -f "$ZSH/plugins/gitfast/git-prompt.sh" ]; then
    ...
    # difference. You can further control.
...
ps -ae | grep XWin || startxwin >/dev/null 2>&1 &
...
Interesting alias in Oh My ZSH: ~x~ = Extract archive of types tar, bz2, rar, gz,
tbz2, tgz, zip, Z, 7z.
...
if [ -d "$HOME/Public/Repositories/org-bash-utils" ]; then
    ...
    . $HOME/Public/Repositories/org-bash-utils/org-alias
    . $HOME/Public/Repositories/org-bash-utils/awk-alias
fi
#+end_src
