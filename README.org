...
archaic ~more~ command, you can only *scroll down* the file.
...
#+begin_src shell
alias svn-log="svn log | svn-short-log | sed -e 's/^\(.*\) | \(.*\) | \(.*\) | \(.*\)$/\o33\[1;33m\1\o33[0m \o33\[1;32m\2\o33[0m \o33\[1;34m\3\o33[0m \4/' | less -RF"
#+end_src
