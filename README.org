...
For Zsh, use ~print $terminfo[bel]~.  For both, use ~tput bel~.
*************** END
...
# LANG="en_US.utf8"
# LC_CTYPE="en_US.utf8"
# LC_ALL="C"                              # Fix the problem of strange characters in the man page.
