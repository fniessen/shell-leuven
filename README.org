...
:PROPERTIES:
:header-args+: :tangle ../../home/.shell_local_after
:END:

Everything in common between Bash and Z shell will come here, since it is read
by both shells.

=.shell_local_after= contains miscellaneous settings common to Bash and Zsh.
...
#+begin_src shell :tangle ../../home/.shell_local_after
